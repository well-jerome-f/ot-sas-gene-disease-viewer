                    ...
                    [
                        ...
                        data_table(
                            ...
                            [
                                ...
                                {"name": "unmet category", "id": "unmet_need_category"},
                                {"name": "prevalence", "id": "unmet_need_prevalence"},
                                {"name": "evidence rows", "id": "evidence_count", "type": "numeric"},
                                {"name": "study loci", "id": "study_locus_count", "type": "numeric"},
                                {"name": "key unmet needs", "id": "unmet_need_key_needs"},
                            ...
                            style_cell_conditional=[
                                ...
                                {"if": {"column_id": "unmet_need_index"}, "width": "90px", "textAlign": "right"},
                                {"if": {"column_id": "unmet_need_category"}, "width": "130px"},
                                {"if": {"column_id": "unmet_need_prevalence"}, "width": "90px"},
                                {"if": {"column_id": "evidence_count"}, "width": "90px", "textAlign": "right"},
                                {"if": {"column_id": "study_locus_count"}, "width": "80px", "textAlign": "right"},
                                {"if": {"column_id": "unmet_need_key_needs"}, "width": "360px"},
